...
# ── PandaScore API ─────────────────────────────────────────────────────────────
API_KEY   = "r6yTi2vBFqFaWI8FUTehaZprD7jWrts0dIrIT3wg914VB49wMcE"
...
SMTP_PORT     = 587
SMTP_USER     = "alertas.climaticos00@gmail.com"       # <- altere
SMTP_PASSWORD = "tnixzryztjnzfeeq"     # <- altere (App Password, não senha normal)
